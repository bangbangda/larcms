    ...
    <div class="page animation-fade page-forms">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">添加房间</li>
            </ol>
        </div>
        <div class="page-content">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">添加房间</h3>
                </div>
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-md-12 col-lg-10">
                            <div class="example-wrap">
                                <form class="form-horizontal" method="post" action="{{ route('house.rooms.store', $house->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 input-group">
                                            <input type="text" class="form-control" value="{{ $house->name }}" disabled autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">户型面积：</label>
                                        <div class="col-md-7 input-group">
                                            <input type="text" class="form-control" value="{{ $house->area }}" disabled autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">房间名称：</label>
                                        <div class="col-md-7 input-group">
                                            <input type="text" class="form-control" value="{{ old('name') }}" name="name" placeholder="房间名称" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">房间排序：</label>
                                        <div class="col-md-7 input-group">
                                            <input type="text" class="form-control" value="{{ old('weight') }}" name="weight" placeholder="排序" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">房间图片：</label>
                                        <div class="col-md-7">
