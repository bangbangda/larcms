    ...
    <div class="page animation-fade page-forms">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">添加专属顾问</li>
            </ol>
        </div>
        <div class="page-content">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">添加专属顾问</h3>
                </div>
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-md-12 col-lg-10">
                            <div class="example-wrap">
                                <form class="form-horizontal" method="post" action="{{ route('salesman.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 input-group">
                                            <input type="text" class="form-control" name="name" value="{{ old('name') }}" autocomplete="off" placeholder="顾问名称">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 input-group">
                                            <input type="text" class="form-control" name="position" value="{{ old('position') }}" placeholder="顾问职位">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 input-group">
                                            <input type="text" class="form-control" name="wechat" value="{{ old('wechat') }}" placeholder="微信号">
                                        </div>
                                    </div>
