                    ...
                    <div class="row row-lg">
                        <div class="col-md-12 col-lg-10">
                            <div class="example-wrap">
                                <form class="form-horizontal" method="post" action="{{ route('activity.shareImage.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3 input-group">
                                            ...
                                            <input type="text" class="form-control" data-plugin="datepicker" value="{{ old('start_date') }}" data-language="zh-CN" data-format="yyyy-mm-dd" name="start_date"  placeholder="开始时间" autocomplete="off">
                                        </div>
                                        <div class="col-md-3 input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control" data-plugin="datepicker" value="{{ old('end_date') }}" data-format="yyyy-mm-dd" data-language="zh-CN" name="end_date" placeholder="结束时间" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
